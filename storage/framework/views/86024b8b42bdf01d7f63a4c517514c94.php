...
<div>
		<p><h6><?php echo e($row->title); ?></h6> <a href="/user/<?php echo e($user->id); ?>/post/<?php echo e($row->id); ?>/edit">Редактировать</a> | <a href="/user/<?php echo e($user->id); ?>/post/<?php echo e($row->id); ?>/delete">Удалить</a>
...
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/user/Downloads/laravelApp/resources/views/user.blade.php ENDPATH**/ ?>